...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
        <spring:form commandName="menu" action="" cssClass="am-form" >
            <div class="am-form-group am-cf">
                <div class="zuo">名称：</div>
                <div class="you">
                    <spring:input path="name" cssClass="am-input-sm" placeholder="请输入名称"/>
                </div>
            </div>
            <div class="am-form-group am-cf">
                <div class="zuo">编号：</div>
                <div class="you">
                    <spring:input path="code" cssClass="am-input-sm" placeholder="请输入编号"/>
                </div>
            </div>
            <div class="am-form-group am-cf">
                <div class="zuo">级别：</div>
                <div class="you">
                    <spring:radiobutton path="level" cssClass="am-input-sm" value="1"/>&nbsp;&nbsp;系统（Sys）
                    <spring:radiobutton path="level" cssClass="am-input-sm" value="2"/>&nbsp;&nbsp;功能（Func）
                </div>
            </div>
            <div class="am-form-group am-cf">
            ...
            <div class="am-form-group am-cf">
                ...
                <div class="you">
                    <spring:input path="sortId" cssClass="am-input-sm" placeholder="请输入排序标识，只能为大于0的整数"/>
                </div>
            </div>
            <div class="am-form-group am-cf">
                <div class="zuo">描述：</div>
                <div class="you">
                    <spring:input path="remark" cssClass="am-input-sm" placeholder="请输入菜单描述"/>
                </div>
            </div>
            ...
            <div class="am-form-group am-cf">
                <div class="you" style="margin-left: 11%;">
                    ...
                    <button type="submit" class="am-btn am-btn-danger am-radius">取消</button>
