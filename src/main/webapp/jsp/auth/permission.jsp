...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/auth/permission.js"></script>
    ...
    <form class="am-form am-g">
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            ...
            <tr class="am-success">
                ...
                <th class="table-id am-text-center">URL</th>
                <th class="table-title am-text-center">状态</th>
                <th class="table-title am-text-center">描述</th>
            ...
            <c:forEach items="${permissionList}" var="permission">
                <tr>
                    <td class="table-id am-text-center">
                        <input type="radio" name="rid" value="${permission.id}"/>
                    </td>
                    <td class="am-text-center"><a href="javascript:toEditPage('${permission.id}')">${permission.name}</a></td>
                    <td class="am-text-center">${permission.typeStr}</td>
                    <th class="am-text-center">${permission.url}</th>
                    <td class="am-text-center">${permission.statusStr}</td>
                    <td class="am-text-center">${permission.des}</td>
                    <td class="am-text-center"><fmt:formatDate value="${permission.createTime}"
        ...
        <p>
            备注：操作图标含义
            <a class="am-icon-pencil-square-o am-text-secondary" title="修改"> 修改权限</a>
            <a class="am-icon-trash-o am-text-danger" title="删除"> 删除权限</a>
        </p>
    </form>
